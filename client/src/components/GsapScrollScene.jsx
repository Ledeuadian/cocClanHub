...
export default function GsapScrollScene({ children }) {
  ...
  return (
    <main
      ref={rootRef}
      // min-h-0 is critical: without it, a flex child like the Chat page
      // can't shrink below its content size and the input box overflows.
      // overflow-y-auto still gives normal scrolling pages their scroll.
      className="gsap-scroll-scene flex-1 min-h-0 overflow-y-auto"
    >
      {children}
    </main>
  )
